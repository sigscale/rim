									...
									Indent5, {'un:IubLink', [{id, "1"}],
											[Indent6, {'un:attributes', [],
													...
													Indent7, {'un:iubLinkUtranCell', [],
															[Indent8, {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=1"]},
															Indent8, {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=2"]},
															Indent8, {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=3"]},
															Indent8, {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=4"]},
															Indent8, {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=5"]},
															Indent8, {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=6"]}, Indent7]},
											...
											Indent6, {'xn:VsDataContainer', [{id, "1"}],
													[Indent7, {'xn:attributes', [],
															...
															Indent8, {'xn:vsDataFormatVersion', [generate_identity(5) ++ ".1.1"]},
															Indent8, {'xn:vsData', []}, Indent7]}, Indent6]}, Indent5]},
									Indent5, {'un:IubLink', [{id, "2"}],
											[Indent6, {'un:attributes', [],
													[Indent7, {'un:userLabel', ["Iub " ++ generate_identity(5)]},
													Indent7, {'un:iubLinkUtranCell', [],
															[Indent8, {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellTDDLcr=1"]},
															Indent8, {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellTDDHcr=1"]},
															Indent8, {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=7"]},
															Indent8, {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=8"]},
															Indent8, {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=9"]},
															Indent8, {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=10"]}, Indent7]},
													Indent7, {'un:aEnd', [generate_identity(5)]},
													Indent7, {'un:zEnd', [generate_identity(5)]}, Indent6]},
											Indent6, {'xn:VsDataContainer', [{id, "1"}],
													[Indent7, {'xn:attributes', [],
