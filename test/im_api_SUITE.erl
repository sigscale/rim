...
init_per_testcase(bulk_cm_geran, Config) ->
	...
	Simple = [indent(0), {bulkCmConfigDataFile, FileAttributes,
			[indent(1), FileHeader, Indent1, ConfigData, Indent1, FileFooter, indent(0)]}],
							...
							indent(4), {'un:RncFunction', [{id, "1"}],
									...
									indent(5), {'un:IubLink', [{id, "1"}],
											[indent(6), {'un:attributes', [],
													...
													indent(7), {'un:iubLinkUtranCell', [],
															[indent(8), {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=1"]},
															indent(8), {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=2"]},
															indent(8), {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=3"]},
															indent(8), {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=4"]},
															indent(8), {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=5"]},
															indent(8), {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=6"]}, indent(7)]},
									...
									indent(5), {'un:IubLink', [{id, "2"}],
											[indent(6), {'un:attributes', [],
													[indent(7), {'un:userLabel', ["Iub " ++ generate_identity(5)]},
													indent(7), {'un:iubLinkUtranCell', [],
															[indent(8), {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellTDDLcr=1"]},
															indent(8), {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellTDDHcr=1"]},
															indent(8), {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=7"]},
															indent(8), {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=8"]},
															indent(8), {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=9"]},
															indent(8), {'xn:dn', ["DC=umts.sigscale.net,SubNetwork=1,ManagedElement=1,RncFunction=1,UtranCellFDD=10"]}, indent(7)]},
													indent(7), {'un:aEnd', [generate_identity(5)]},
													indent(7), {'un:zEnd', [generate_identity(5)]}, indent(6)]},
											indent(6), {'xn:VsDataContainer', [{id, "1"}],
													[indent(7), {'xn:attributes', [],
			...
			F2(N, Acc) ->
				CellTDD = {'en:EUtranCellFDD', [{id, integer_to_list(N)}],
						[indent(6), {'en:attributes', [],
								...
								indent(7), {'en:earfcnUl', ["391"]}, indent(6)]}, Tabs5] ++ F1(3, []) ++
						[indent(6), {'xn:VsDataContainer', [{id, "1"}],
								[indent(7), {'xn:attributes', [],
										[indent(8), {'xn:vsDataType', ["DataType=" ++ integer_to_list(N)]},
										indent(8), {'xn:vsDataFormatVersion', [generate_identity(5) ++ ".1.1"]},
			...
			F3(N, Acc) ->
				CellTDD = {'en:EUtranCellTDD', [{id, integer_to_list(N)}],
						[indent(6), {'en:attributes', [],
								...
								indent(7), {'en:specialSfPatterns', ["753"]}, indent(6)]}, Tabs5] ++ F1(3, []) ++
						[indent(6), {'xn:VsDataContainer', [{id, "1"}],
								[indent(7), {'xn:attributes', [],
										[indent(8), {'xn:vsDataType', ["DataType=" ++ integer_to_list(N)]},
										indent(8), {'xn:vsDataFormatVersion', [generate_identity(5) ++ ".1.1"]},
			...
			[indent(2), {'xn:SubNetwork', [{id, "1"}],
					...
					indent(3), {'xn:ManagedElement', [{id, "1"}],
							[indent(4), {'xn:attributes', [],
									[indent(5), {'xn:dnPrefix', []},
									indent(5), {'xn:managedElementTypeList', [],
											[indent(6), {'xn:managedElementType', ["EPDG"]}, indent(5)]},
			...
			[indent(2), {'xn:SubNetwork', [{id, "1"}],
					...
					indent(3), {'xn:ManagementNode', [{id, "1"}],
							[indent(4), {'xn:attributes', [],
									...
									indent(5), {'xn:locationName', [generate_identity(7)]},
									indent(5), {'xn:managedElements', [],
											[indent(6), {'xn:dn', ["SubNetwork=1,MscFunction=1"]}, indent(5)]},
									indent(5), {'xn:swVersion', ["1.0"]}, indent(4)]}, indent(3)]},
					indent(3), {'xn:ManagedElement', [{id, "1"}],
							[indent(4), {'xn:attributes', [],
									[indent(5), {'xn:dnPrefix', []},
									indent(5), {'xn:managedElementTypeList', [],
											[indent(6), {'xn:managedElementType', ["MscServer"]}, indent(5)]},
									indent(5), {'xn:userLabel', ["ME " ++ generate_identity(5)]},
									indent(5), {'xn:vendorName', [generate_identity(7)]},
									indent(5), {'xn:userDefinedState', ["commercial"]},
									indent(5), {'xn:locationName', [generate_identity(7)]},
			...
			[indent(2), {'xn:SubNetwork', [{id, "1"}],
					...
					indent(3), {'xn:ManagedElement', [{id, "1"}],
							[indent(4), {'xn:attributes', [],
									[indent(5), {'xn:dnPrefix', []},
									indent(5), {'xn:managedElementTypeList', [],
											[indent(6), {'xn:managedElementType', ["AS"]}, indent(5)]},
									indent(5), {'xn:userLabel', ["ME " ++ generate_identity(5)]},
									indent(5), {'xn:vendorName', [generate_identity(7)]},
									indent(5), {'xn:userDefinedState', ["commercial"]},
									indent(5), {'xn:locationName', [generate_identity(7)]},
			...
			[indent(2), {'xn:SubNetwork', [{id, "1"}],
					...
					indent(3), {'xn:ManagedElement', [{id, "1"}],
							[indent(4), {'xn:attributes', [],
									[indent(5), {'xn:dnPrefix', []},
									indent(5), {'xn:managedElementTypeList', [],
											[indent(6), {'xn:managedElementType', ["MonitoredEntity"]}, indent(5)]},
			...
			[indent(2), {'xn:SubNetwork', [{id, "1"}],
					...
					indent(3), {'xn:ManagedElement', [{id, "1"}],
							[indent(4), {'xn:attributes', [],
									[indent(5), {'xn:dnPrefix', []},
									indent(5), {'xn:managedElementTypeList', [],
											[indent(6), {'xn:managedElementType', ["3GPPAAAServer"]}, indent(5)]},
									indent(5), {'xn:userLabel', ["ME 1" ++ generate_identity(5)]},
									indent(5), {'xn:vendorName', [generate_identity(7)]},
									indent(5), {'xn:userDefinedState', ["commercial"]},
									indent(5), {'xn:locationName', [generate_identity(7)]},
			...
			F(N, Acc) ->
				InventoryUnit = {'in:InventoryUnit', [{id, integer_to_list(N)}],
						[indent(5), {'in:attributes', [],
								...
								indent(6), {'in:unitPosition', ["Rack=" ++ integer_to_list(N)]}, Indent6]},
						indent(5), {'xn:VsDataContainer', [{id, "1"}],
								[indent(6), {'xn:attributes', [],
					...
					indent(3), {'xn:ManagedElement', [{id, "1"}],
							...
							indent(4), {'in:InventoryUnitNE', [{id, "1"}],
									[indent(5), {'in:attributes', [],
											...
											indent(6), {'in:mFunction', ["Subtwork=1,ManagedElement=1,RncFunction=1"]},
											indent(6), {'in:hWList', [],
													[indent(7), {'xn:dn', ["Subtwork=1,ManagedElement=1,InventoryUnitHw=1"]},
													indent(7), {'xn:dn', ["Subtwork=1,ManagedElement=1,InventoryUnitHw=1,InventoryUnitHw=1"]},
													indent(7), {'xn:dn', ["Subtwork=1,ManagedElement=1,InventoryUnitHw=1,InventoryUnitHw=1,InventoryUnitHw=1"]},
													indent(7), {'xn:dn', ["Subtwork=1,ManagedElement=1,InventoryUnitHw=1,InventoryUnitHw=1,InventoryUnitHw=2"]}, indent(6)]},
											indent(6), {'in:sWList', [],
													[indent(7), {'xn:dn', ["Subtwork=1,ManagedElement=1,InventoryUnitSw=1"]}, indent(6)]},
											indent(6), {'in:lICList', [],
													[indent(7), {'xn:dn', ["Subtwork=1,ManagedElement=1,InventoryUnitLic=1"]}, indent(6)]}, indent(5)]}, indent(4)]},
							indent(4), {'in:InventoryUnitHw', [{id, "1"}],
									[indent(5), {'in:attributes', [],
											...
											indent(6), {'in:mFunction', ["Subtwork=1,ManagedElement=1,RncFunction=1"]},
											indent(6), {'in:nEList', [],
													[indent(7), {'xn:dn', ["Subtwork=1,ManagedElement=1,InventoryUnitNE=1"]}, indent(6)]},
											indent(6), {'in:sWList', [],
													[indent(7), {'xn:dn', ["Subtwork=1,ManagedElement=1,InventoryUnitSw=1"]}, indent(6)]}, indent(5)]},
									indent(5), {'in:InventoryUnitHw', [{id, "1"}],
											[indent(6), {'in:attributes', [],
													...
													indent(7), {'in:mFunction', ["Subtwork=1,ManagedElement=1,RncFunction=1"]},
													indent(7), {'in:nEList', [],
															[indent(8), {'xn:dn', ["Subtwork=1,ManagedElement=1,InventoryUnitNE=1"]}, indent(7)]},
													indent(7), {'in:sWList', [],
															[indent(8), {'xn:dn', ["Subtwork=1,ManagedElement=1,InventoryUnitSw=1"]}, indent(7)]}, indent(6)]},
											indent(6), {'in:InventoryUnitHw', [{id, "1"}],
													[indent(7), {'in:attributes', [],
															...
															indent(8), {'in:mFunction', ["Subtwork=1,ManagedElement=1,RncFunction=1"]},
															indent(8), {'in:nEList', [],
																	[indent(9), {'xn:dn', ["Subtwork=1,ManagedElement=1,InventoryUnitNE=1"]}, indent(8)]},
															indent(8), {'in:sWList', [],
																	[indent(9), {'xn:dn', ["Subtwork=1,ManagedElement=1,InventoryUnitSw=1"]}, indent(8)]}, indent(7)]}, indent(6)]},
											indent(6), {'in:InventoryUnitHw', [{id, "2"}],
													[indent(7), {'in:attributes', [],
															...
															indent(8), {'in:nEList', [],
																	[indent(9), {'xn:dn', ["Subtwork=1,ManagedElement=1,InventoryUnitNE=1"]}, indent(8)]},
															indent(8), {'in:sWList', [],
																	[indent(9), {'xn:dn', ["Subtwork=1,ManagedElement=1,InventoryUnitSw=1"]}, indent(8)]}, indent(7)]}, indent(6)]}, indent(5)]}, indent(4)]},
							indent(4), {'in:InventoryUnitSw', [{id, "1"}],
									[indent(5), {'in:attributes', [],
											...
											indent(6), {'in:mFunction', ["Subtwork=1,ManagedElement=1,RncFunction=1"]},
											indent(6), {'in:nEList', [],
													[indent(7), {'xn:dn', ["Subtwork=1,ManagedElement=1,InventoryUnitNE=1"]},
															indent(6)]},
											indent(6), {'in:hWList', [],
													[indent(7), {'xn:dn',["Subtwork=1,ManagedElement=1,InventoryUnitHw=1,InventoryUnitHw=1,InventoryUnitHw=1"]}, indent(6)]},
											indent(6), {'in:lICList', [],
													[indent(7), {'xn:dn', ["Subtwork=1,ManagedElement=1,InventoryUnitLic=1"]},
