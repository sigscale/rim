			...
			F(N, Acc) ->
				Resource = {'xn:ManagedElement', [{id, integer_to_list(N)}],
						[Indent4, {'xn:attributes', [],
								...
								Indent5, {'xn:managedElementType', ["RNC"]},
...
init_per_testcase(bulk_cm_geran, Config) ->
	...
	F = fun F(0, Acc) ->
				[Indent3, {'gn:BtsSiteMgr', [{id, "1"}],
						[Indent4, {'gn:attributes', [],
								...
								Indent5, {'gn:latitude', ["90.25"]},
								Indent5, {'gn:longitude', ["45.09"]},
								Indent5, {'gn:locationName', ["Montparnasse"]},
	...
	FileAttributes = [{xmlns, "http://www.3gpp.org/ftp/specs/archive/32_series/32.616#configData"},
			{'xmlns:xn', "http://www.3gpp.org/ftp/specs/archive/32_series/32.626#genericNrm"},
			{'xmlns:gn', "http://www.3gpp.org/ftp/specs/archive/32_series/32.656#geranNrm"}],
	FileHeader = {fileHeader, [{fileFormatVersion, "32.616 V15.0"},
			{senderName, "DC=a1.companyNN.com,SubNetwork=1,IRPAgent=1"},
			{vendorName, "Company NN"}], []},
	ConfigData = {configData, [{dnPrefix, "DC=a1.companyNN.com"}],
			[Indent2, {'gn:BssFunction', [{id, "1"}],
					[Indent3, {'xn:attributes', [],
							[Indent4, {'xn:userLabel', ["BssFunction=1"]}, Indent3]} | Resources] ++ [Indent2]},
									Indent1]},
...
init_per_testcase(bulk_cm_utran, Config) ->
	...
	F = fun F(0, Acc) ->
				[Indent3, {'un:UtranCellFDD', [{id, "1"}],
						[Indent4, {'un:attributes', [],
								...
								Indent5, {'un:numOfHspdschs', ["0"]},
								Indent5, {'un:isChangeForEnergySavingAllowed', ["false"]},
										Indent4]}, Indent3]} | Acc];
			F(N, Acc) ->
	...
	FileAttributes = [{xmlns, "http://www.3gpp.org/ftp/specs/archive/32_series/32.616#configData"},
			{'xmlns:xn', "http://www.3gpp.org/ftp/specs/archive/32_series/32.626#genericNrm"},
			{'xmlns:sm', "http://www.3gpp.org/ftp/specs/archive/32_series/32.676#stateManagementIRP"},
			{'xmlns:un', "http://www.3gpp.org/ftp/specs/archive/32_series/32.646#utranNrm"}],
	FileHeader = {fileHeader, [{fileFormatVersion, "32.616 V15.0"},
			{senderName, "DC=a1.companyNN.com,SubNetwork=1,IRPAgent=1"},
			{vendorName, "Company NN"}], []},
	ConfigData = {configData, [{dnPrefix, "DC=a1.companyNN.com"}],
			[Indent2, {'un:RncFunction', [{id, "1"}],
					[Indent3, {'un:attributes', [],
							...
							Indent4, {'un:intraANRSwitch', ["true"]},
							Indent4, {'un:mcc', ["MCC"]},
...
init_per_testcase(bulk_cm_eutran, Config) ->
	...
	Indent6 = #xmlText{value = "\n\t\t\t\t\t\t",type = text},
	F = fun F(0, Acc) ->
				[Indent3, {'sp:SONFuncInfo', [{id, "1"}],
						[Indent4, {'sp:attributes', [],
								[Indent5, {'sp:sonFuncCapabilityBelowItfN', [],
										[Indent6, {'sp:SonFuncName', ["anr"]},
										Indent6, {'sp:SonFuncName', ["lbo"]},
										Indent6, {'sp:SonFuncName', ["coc"]},
			...
			F(N, Acc) ->
				Resource = {'en:EUtranCellTDD', [{id, integer_to_list(N)}],
						[Indent4, {'en:attributes', [],
								...
								Indent5, {'en:relatedTmaList', [],
										[Indent6, {'en:dn', ["ENBFunction=1,EUtranCellTDD=" ++
												integer_to_list(N)]},
										Indent6, {'en:dn', ["ENBFunction=1,EUtranCellTDD=" ++
												integer_to_list(N)]}, Indent5]},
								Indent5, {'en:administrativeState', ["shuttingDown"]},
								Indent5, {'en:cellResvInfo', ["nonReservedCell"]},
								Indent5, {'en:sfAssignment', ["789"]}, Indent4]}, Indent3]},
				F(N - 1, [Indent3, Resource | Acc])
	end,
	Resources = F(NumResources, []),
	FileAttributes = [{xmlns, "http://www.3gpp.org/ftp/specs/archive/32_series/32.616#configData"},
...
init_per_testcase(bulk_cm_epc, Config) ->
	...
	FileAttributes = [{xmlns, "http://www.3gpp.org/ftp/specs/archive/32_series/32.616#configData"},
			{'xmlns:xn', "http://www.3gpp.org/ftp/specs/archive/32_series/32.626#genericNrm"},
			{'xmlns:epc', "http://www.3gpp.org/ftp/specs/archive/32_series/32.756#epcNrm"}],
	FileHeader = {fileHeader, [{fileFormatVersion, "32.616 V15.0"},
			{senderName, "DC=a1.companyNN.com,SubNetwork=1,IRPAgent=1"},
			{vendorName, "Company NN"}], []},
	ConfigData = {configData, [{dnPrefix, "DC=a1.companyNN.com"}],
