					...
					indent(3), {'xn:ManagedElement', [{id, "1"}],
							...
							indent(4), {'epc:EPDGFunction', [{id, "1"}],
									...
									indent(5), {'epc:EP_RP_EPS', [{id, "1"}],
											[indent(6), {'epc:attributes', [],
													[indent(7), {'epc:farEndEntity',
															[indent(8), "DC=sigscale.net,SubNetwork=4,ManagedElement=1,"
																	"PGWFunction=1,EP_RP_EPS=1", indent(7)]},
									...
									indent(5), {'epc:EP_RP_EPS', [{id, "2"}],
											[indent(6), {'epc:attributes', [],
													[indent(7), {'epc:farEndEntity',
															[indent(8), "DC=sigscale.net,SubNetwork=4,ManagedElement=1,"
																	"PCRFFunction=1,EP_RP_EPS=1", indent(7)]},
													indent(7), {'epc:userLabel', ["EP-PCRF-2"]}, indent(6)]},
															indent(5)]}, indent(4)]},
							indent(4), {'epc:MMEFunction', [{id, "1"}],
									...
									indent(5), {'epc:EP_RP_EPS', [{id, "1"}],
											[indent(6), {'epc:attributes', [],
													[indent(7), {'epc:farEndEntity',
															[indent(8), "DC=sigscale.net,SubNetwork=4,"
																	"ServingGWFunction=1,EP_RP_EPS=1", indent(7)]},
											...
											indent(6), {'xn:VsDataContainer', [{id, "1"}],
													[indent(7), {'xn:attributes', [],
															...
															indent(8), {'xn:vsData', []}, indent(7)]},
																	indent(6)]}, indent(5)]},
									indent(5), {'epc:EP_N26', [{id, "1"}],
											[indent(6), {'epc:attributes', [],
													[indent(7), {'epc:farEndEntity',
															[indent(8), "DC=sigscale.net,SubNetwork=12,ManagedEntity=1,"
																	"AMFFunction=1,EP_N26=1", indent(7)]},
													indent(7), {'epc:userLabel', ["EP-AMF-1"]}, indent(6)]},
															indent(5)]}, indent(4)]},
							indent(4), {'epc:PCRFFunction', [{id, "1"}],
									...
									indent(5), {'epc:EP_RP_EPS', [{id, "1"}],
											[indent(6), {'epc:attributes', [],
													[indent(7), {'epc:farEndEntity',
															[indent(8), "DC=sigscale.net,SubNetwork=4,ManagedEntity=1,"
																	"EPDGFunction=1,EP_RP_EPS=2", indent(7)]},
									...
									indent(5), {'epc:EP_RP_EPS', [{id, "2"}],
											[indent(6), {'epc:attributes', [],
													[indent(7), {'epc:farEndEntity',
															[indent(8), "DC=sigscale.net,SubNetwork=4,ManagedEntity=1,"
																	"PGWFunction=1,EP_RP_EPS=2", indent(7)]},
													indent(7), {'epc:userLabel', ["EP-PGW-2"]}, indent(6)]}, indent(5)]},
									indent(5), {'epc:EP_RP_EPS', [{id, "3"}],
											[indent(6), {'epc:attributes', [],
													[indent(7), {'epc:farEndEntity',
															[indent(8), "DC=sigscale.net,SubNetwork=4,ManagedEntity=1,"
																	"ServingGWFunction=1,EP_RP_EPS=2", indent(7)]},
													indent(7), {'epc:userLabel', ["EP-ServingGW-2"]}, indent(6)]},
															indent(5)]}, indent(4)]},
							indent(4), {'epc:PGWFunction', [{id, "1"}],
									...
									indent(5), {'epc:EP_RP_EPS', [{id, "1"}],
											[indent(6), {'epc:attributes', [],
													[indent(7), {'epc:farEndEntity',
															[indent(8), "DC=sigscale.net,SubNetwork=4,ManagedEntity=1,"
																	"EPDGFunction=1,EP_RP_EPS=1", indent(7)]},
													indent(7), {'epc:userLabel', ["EP-EPDG-1"]}, indent(6)]},
											indent(6), {'xn:VsDataContainer', [{id, "1"}],
													[indent(7), {'xn:attributes', [],
									...
									indent(5), {'epc:EP_RP_EPS', [{id, "2"}],
											[indent(6), {'epc:attributes', [],
													[indent(7), {'epc:farEndEntity',
															[indent(8), "DC=sigscale.net,SubNetwork=4,ManagedEntity=1,"
																	"PCRFFunction=1,EP_RP_EPS=2", indent(7)]},
													indent(7), {'epc:userLabel', ["EP-PCRF-2"]}, indent(6)]}, indent(5)]},
									indent(5), {'epc:EP_RP_EPS', [{id, "3"}],
											[indent(6), {'epc:attributes', [],
													[indent(7), {'epc:farEndEntity',
															[indent(8), "DC=sigscale.net,SubNetwork=4,ManagedEntity=1,"
																	"ServingGWFunction=1,EP_RP_EPS=3", indent(7)]},
													indent(7), {'epc:userLabel', ["EP-ServingGW-3"]}, indent(6)]},
															indent(5)]}, indent(4)]},
							indent(4), {'epc:ServingGWFunction', [{id, "1"}],
									...
									indent(5), {'epc:EP_RP_EPS', [{id, "1"}],
											[indent(6), {'epc:attributes', [],
													[indent(7), {'epc:farEndEntity',
															[indent(8), "DC=sigscale.net,SubNetwork=4,ManagedElement=1,"
																	"MMEFunction=1,EP_RP_EPS=1", indent(7)]},
													indent(7), {'epc:userLabel', ["EP-MME-1"]}, indent(6)]},
											indent(6), {'xn:VsDataContainer', [{id, "1"}],
													[indent(7), {'xn:attributes', [],
									...
									indent(5), {'epc:EP_RP_EPS', [{id, "2"}],
											[indent(6), {'epc:attributes', [],
													[indent(7), {'epc:farEndEntity',
															[indent(8), "DC=sigscale.net,SubNetwork=4,ManagedElement=1,"
																	"PCRFFunction=1,EP_RP_EPS=3", indent(7)]},
													indent(7), {'epc:userLabel', ["EP-PCRF-1"]}, indent(6)]}, indent(5)]},
									indent(5), {'epc:EP_RP_EPS', [{id, "3"}],
											[indent(6), {'epc:attributes', [],
													[indent(7), {'epc:farEndEntity',
															[indent(8), "DC=sigscale.net,SubNetwork=4,ManagedElement=1,"
																	"PGWFunction=1,EP_RP_EPS=3", indent(7)]},
													indent(7), {'epc:userLabel', ["EP-PGW-1"]}, indent(6)]},
															indent(5)]}, indent(4)]},
							indent(4), {'xn:VsDataContainer', [{id, "1"}],
									[indent(5), {'xn:attributes', [],
...
init_per_testcase(bulk_cm_5gc, Config) ->
	...
	AmfEpN14_1 = Endpoint('ngc:EP_N14', "1", "EP-AMF-2", "DC=sigscale.net,"
			"SubNetwork=12,ManagedElement=1,AMFFunction=2,EP_N14=1"),
	AmfEpN14_2 = Endpoint('ngc:EP_N14', "1", "EP-AMF-1", "DC=sigscale.net,"
			"SubNetwork=12,ManagedElement=1,AMFFunction=1,EP_N14=1"),
	...
	UpfEpN9_1 = Endpoint('ngc:EP_N9', "1", "EP-UPF-2", "DC=sigscale.net,"
			"SubNetwork=12,ManagedElement=1,UPFFunction=2,EP_N9=1"),
	UpfEpN9_2 = Endpoint('ngc:EP_N9', "1", "EP-UPF-1", "DC=sigscale.net,"
			"SubNetwork=12,ManagedElement=1,UPFFunction=1,EP_N9=1"),
			...
			[indent(2), {'xn:SubNetwork', [{id, "12"}],
					...
					indent(3), {'xn:ManagedElement', [{id, "1"}],
							...
							indent(4), {'ngc:AMFFunction', [{id, "1"}],
									...
									indent(5), AmfEpN14_1, indent(5), AmfEpN15, indent(5), AmfEpN17, indent(5), AmfEpN20,
									indent(5), AmfEpN22, indent(5), AmfEpN26, indent(5), AmfEpNls, indent(5), AmfEpNlg,
									indent(5), AmfEpSbiX, indent(4)]},
							indent(4), {'ngc:AMFFunction', [{id, "2"}],
									[indent(5), {'ngc:attributes', [],
											[indent(6), {'ngc:userLabel', ["amf-2"]},
											indent(6), {'ngc:pLMNIdList', [],
													[indent(7), {'en:pLMNId', [],
															[indent(8), {'en:mcc', ["293"]},
															indent(8), {'en:mnc', ["781"]}, indent(7)]}, indent(6)]},
											indent(6), {'ngc:aMFIdentifier', [],
													[indent(7), {'ngc:amfRegionId', ["254"]},
													indent(7), {'ngc:amfSetId', ["1022"]},
													indent(7), {'ngc:amfPointer', ["64"]}, indent(6)]},
											indent(6), {'ngc:sBIFqdn', [generate_identity(7)]},
											indent(6), {'ngc:sBISerivceList', [],
													[indent(7), {'ngc:nfServices', [],
															[indent(8), {'ngc:serviceInstanceId', ["478524"]},
															...
															indent(8), {'ngc:ipEndPoints', [],
																	[indent(9), {'ngc:ipEndPoint', [],
																			[indent(10), {'nn:ipv4Address', ["69.89.31.224"]},
																			indent(10), {'nn:ipv6Address',
																					["2002:4559:1FE2:0:0:0:4559:1FE1"]},
																			indent(10), {'nn:ipv6Prefix', ["2002:4559:1FE2:0000::"]},
																			indent(10), {'nn:vlanId', ["3123"]}, indent(9)]},
																					indent(8)]},
															indent(8), {'ngc:apiPrefix', ["IM"]},
															...
															indent(8), {'ngc:allowedNfTypes', [],
																	[indent(9), {'ngc:NFType', ["AMF"]}, indent(8)]},
															indent(8), {'ngc:allowedNssais', [],
																	[indent(9), {'ngc:sst', ["243"]},
																	indent(9), {'ngc:sd', ["65432"]}, indent(8)]},
															indent(8), {'ngc:capacity', ["high"]},
															indent(8), {'ngc:supportedFeatures', ["sf-2"]}, indent(7)]}, indent(6)]},
											indent(6), {'ngc:weightFactor', ["86"]},
											indent(6), {'ngc:snssaiList', [],
													[indent(7), {'ngc:sNssai', [],
															[indent(8), {'ngc:sst', ["234"]},
															indent(8), {'ngc:sd', ["65431"]}, indent(7)]}, indent(6)]},
											indent(6), {'ngc:aMFSet', ["86"]}, indent(5)]}, indent(5), AmfEpN14_2, indent(4)]},
							...
							indent(4), {'ngc:UPFFunction', [{id, "1"}],
									...
									indent(5), UpfEpN3, indent(5), UpfEpN4, indent(5), UpfEpN6, indent(5), UpfEpN9_1,
									indent(5), UpfEpS5u, indent(5), UpfEpSbiX, indent(4)]},
							indent(4), {'ngc:UPFFunction', [{id, "2"}],
									[indent(5), {'ngc:attributes', [],
											[indent(6), {'ngc:userLabel', ["upf-2"]},
											indent(6), {'ngc:pLMNIdList', [],
													[indent(7), {'en:pLMNId', [],
															[indent(8), {'en:mcc', ["292"]},
															indent(8), {'en:mnc', ["783"]}, indent(7)]}, indent(6)]},
											indent(6), {'ngc:nRTACList', [],
													[indent(7), {'ngc:tac', ["164"]}, indent(6)]}, indent(5)]},
									indent(5), UpfEpN9_2, indent(4)]},
	...
	file:write_file(XMLPath, NrNrmXML),
	Config;
init_per_testcase(bulk_cm_slice, Config) ->
	FileAttributes = [{xmlns, "http://www.3gpp.org/ftp/specs/archive/32_series/32.616#configData"},
			{'xmlns:xn', "http://www.3gpp.org/ftp/specs/archive/28_series/28.623#genericNrm"},
			{'xmlns:en', "http://www.3gpp.org/ftp/specs/archive/28_series/28.659#eutranNrm"},
			{'xmlns:ngc', "http://www.3gpp.org/ftp/specs/archive/28_series/28.541#ngcNrm"},
	...
	FileHeader = {fileHeader, [{fileFormatVersion, "32.616 V15.0"},
			{senderName, "DC=sigscale.net,SubNetwork=13,ManagementNode=1,IRPAgent=1"},
			{vendorName, "Acme"}], []},
	ConfigData = {configData, [{dnPrefix, "DC=sigscale.net"}],
			[indent(2), {'xn:SubNetwork', [{id, "13"}],
					[indent(3), {'xn:attributes', [],
							[indent(4), {'xn:userLabel', ["sn-13"]},
							indent(4), {'xn:userDefinedNetworkType', ["Slice"]},
							indent(4), {'xn:setOfMcc', ["594"]}, indent(3)]},
					indent(3), {'xn:ManagementNode', [{id, "1"}],
							[indent(4), {'xn:attributes', [],
									[indent(5), {'xn:userLabel', ["ems-slice-1"]},
									indent(5), {'xn:vendorName', [generate_identity(7)]},
									indent(5), {'xn:userDefinedState', ["commercial"]},
									indent(5), {'xn:locationName', [generate_identity(7)]},
									indent(5), {'xn:managedElements', [],
											[indent(6), {'xn:dn', ["DC=sigscale.net,SubNetwork=13,ManagedElement=1"]},
													indent(5)]},
									indent(5), {'xn:swVersion', ["1.1"]}, indent(4)]}, indent(3)]},
					indent(3), {'xn:ManagedElement', [{id, "1"}],
							[indent(4), {'xn:attributes', [],
									...
									indent(5), {'xn:swVersion', ["1.5.31"]},
									indent(5), {'xn:managedBy', [],
											[indent(6), {'xn:dn', ["DC=sigscale.net,SubNetwork=13,ManagementNode=1"]},
													indent(5)]}, indent(4)]},
							indent(4), {'xn:VsDataContainer', [{id, "1"}],
									[indent(5), {'xn:attributes', [],
											[indent(6), {'xn:vsDataType', ["acmeParam967"]},
											indent(6), {'xn:vsDataFormatVersion', ["cmeParams-v236"]},
											indent(6), {'xn:vsData', []}, indent(5)]}, indent(4)]}, indent(3)]},
					indent(3), {'sl:NetworkSlice', [{id, "1"}],
							[indent(4), {'xn:attributes', [],
									[indent(5), {'sl:dnPrefix', ["DC=sigscale.net"]},
									indent(5), {'sl:userLabel', ["network-slice-1"]},
									indent(5), {'sl:userDefinedNetworkType', ["Slice"]},
									indent(5), {'sl:nSSIId', ["DC=sigscale.net,SubNetwork=13,NetworkSliceSubnet=1"]},
									indent(5), {'sl:operationalState', ["enabled"]},
									indent(5), {'sl:administrativeState', ["locked"]},
									indent(5), {'sl:serviceProfileList', [],
											[indent(6), {'sl:serviceProfile', [],
													[indent(7), {'sl:serviceProfileId', ["sp-001"]},
													indent(7), {'sl:sNSSAIList', [],
															[indent(8), {'ngc:sNssai', [],
																	[indent(9), {'ngc:sst', ["250"]},
																	indent(9), {'ngc:sd', ["65525"]}, indent(8)]}, indent(7)]},
													indent(7), {'sl:pLMNIdList', [],
															[indent(8), {'en:pLMNId', [],
																	[indent(9), {'en:mcc', ["291"]},
																	indent(9), {'en:mnc', ["782"]}, indent(8)]}, indent(7)]},
													indent(7), {'sl:perfReq', [],
															[indent(8), {'sl:perfReqEMBB', [],
																	[indent(9), {'sl:expDataRateUL', ["178"]},
																	indent(9), {'sl:userDensity', ["569"]}, indent(8)]}, indent(7)]},
													indent(7), {'sl:sst', ["245"]}, indent(6)]}, indent(5)]},
															indent(4)]}, indent(3)]},
					indent(3), {'sl:NetworkSliceSubnet', [{id, "1"}],
							[indent(4), {'xn:attributes', [],
									[indent(5), {'sl:dnPrefix', ["DC=sigscale.net"]},
									indent(5), {'sl:userLabel', ["network-slice-subnet-1"]},
									indent(5), {'sl:userDefinedNetworkType', ["Slice"]},
									indent(5), {'sl:mFIdList', [],
											[indent(6), {'xn:dn', ["DN-1"]}, indent(5)]},
									indent(5), {'sl:ConstituentNSSIIdList', [],
											[indent(6), {'xn:dn', ["DC=sigscale.net,SubNetwork=13,NetworkSliceSubnet=1"]},
													indent(5)]},
									indent(5), {'sl:operationalState', ["disabled"]},
									indent(5), {'sl:administrativeState', ["shuttingDown"]},
									indent(5), {'sl:sliceProfileList', [],
											[indent(6), {'sl:sliceProfile', [],
													[indent(7), {'sl:sliceProfileId', ["slp-001"]},
													indent(7), {'sl:sNSSAIList', [],
															[indent(8), {'ngc:sNssai', [],
																	[indent(9), {'ngc:sst', ["249"]},
																	indent(9), {'ngc:sd', ["65524"]}, indent(8)]}, indent(7)]},
													indent(7), {'sl:pLMNIdList', [],
															[indent(8), {'en:pLMNId', [],
																	[indent(9), {'en:mcc', ["290"]},
																	indent(9), {'en:mnc', ["781"]}, indent(8)]}, indent(7)]},
													indent(7), {'sl:perfReq', [],
															[indent(8), {'sl:perfReqEMBB', [],
																	[indent(9), {'sl:expDataRateUL', ["179"]},
																	indent(9), {'sl:userDensity', ["570"]}, indent(8)]}, indent(7)]},
																			indent(6)]}, indent(5)]}, indent(4)]}, indent(3)]},
																			indent(2)]}, indent(1)]},
	FileFooter = {fileFooter, [{dateTime, "2020-07-21T23:00:00Z"}], []},
	Simple = [indent(0), {bulkCmConfigDataFile, FileAttributes,
			[indent(1), FileHeader, indent(1), ConfigData, indent(1), FileFooter, indent(0)]}],
	SliceNrmXML = lists:flatten(xmerl:export_simple(Simple, xmerl_xml, [])),
	PrivDir = ?config(priv_dir, Config),
	XMLPath = PrivDir ++ "/" ++ "slice.xml",
	file:write_file(XMLPath, SliceNrmXML),
	Config;
...
all() ->
	[bulk_cm_geran, bulk_cm_utran, bulk_cm_eutran, bulk_cm_epc, bulk_cm_core,
			...
			bulk_cm_inventory2, bulk_cm_nr, bulk_cm_5gc, bulk_cm_slice,
...
bulk_cm_epc(Config) ->
	...
	#xmlElement{content = _MmeEpN26Content,
			attributes = MmeEpN26Attr} = lists:keyfind('epc:EP_N26',
			#xmlElement.name, MmeContent),
	#xmlAttribute{value = MmeEpN26Id} = lists:keyfind(id,
			#xmlAttribute.name, MmeEpN26Attr),
	...
	MmeEpName = lists:flatten([DnPrefix, ",SubNetwork=", SubnetId,
			",ManagedElement=", MeId, ",MMEFunction=", MmeId,
			",EP_RP_EPS=", MmeEpId]),
	MmeEpN26Name = lists:flatten([DnPrefix, ",SubNetwork=", SubnetId,
			",ManagedElement=", MeId, ",MMEFunction=", MmeId,
			",EP_N26=", MmeEpN26Id]),
	...
	{ok, #resource{name = MmeEpN26Name}} = im:get_resource_name(MmeEpN26Name),
...
bulk_cm_slice() ->
	[{userdata, [{doc, "Import bulk CM for slice network resources"}]}].

bulk_cm_slice(Config) ->
	PrivDir = ?config(priv_dir, Config),
	SliceXML = PrivDir ++ "/" ++ "slice.xml",
	ok = im:import(SliceXML),
	{#xmlElement{content = BulkCmContent}, []} = xmerl_scan:file(SliceXML),
	#xmlElement{content = ConfigContent,
			attributes = ConfigAttr} = lists:keyfind(configData,
			#xmlElement.name, BulkCmContent),
	#xmlAttribute{value = DnPrefix} = lists:keyfind(dnPrefix,
	...
	#xmlAttribute{value = SubnetId} = lists:keyfind(id,
			#xmlAttribute.name, SubnetAttr),
	#xmlElement{content = _NSContent,
			attributes = NSAttr} = lists:keyfind('sl:NetworkSlice',
			#xmlElement.name, SubnetContent),
	#xmlAttribute{value = NSId} = lists:keyfind(id,
			#xmlAttribute.name, NSAttr),
	#xmlElement{content = _NSSContent,
			attributes = NSSAttr} = lists:keyfind('sl:NetworkSliceSubnet',
			#xmlElement.name, SubnetContent),
	#xmlAttribute{value = NSSId} = lists:keyfind(id,
			#xmlAttribute.name, NSSAttr),
	NSName = lists:flatten([DnPrefix, ",SubNetwork=", SubnetId,
			",NetworkSlice=", NSId]),
	NSSName = lists:flatten([DnPrefix, ",SubNetwork=", SubnetId,
			",NetworkSliceSubnet=", NSSId]),
	{ok, #resource{name = NSName}} = im:get_resource_name(NSName),
	{ok, #resource{name = NSSName}} = im:get_resource_name(NSSName).
