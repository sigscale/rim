...
map_to_resource(_Config) ->
	...
	#specification_ref{id = ResourceId, href = ResouceHref, name = ResourceName,
			...
			connectionPointSpecification = [ConPointSpec]} = S,
	#related_party_ref{id = PartyId, href = PartyHref} = RP,
	...
	#connectivity{name = "Connectivity test", type = "Connectivity type",
			minItems = 5, endPoints = [Point]} = End,
	#connectivity_spec{name = "Connectivity spec test", type =
			"Connectivity spec type", minItems = 2, endPoint = [PointSpec]} = ConEnd,
	#point{href = "http://35.229.193.25:8088/eventManagement/v1/event",
			id = "123", name = "Point name", isRoot = true,
			connectionPoint = [ConPoint]} = Point,
	#point_spec{href = "http://35.229.193.25:8088/eventManagement/v1/event",
			id = "258", name = "Point spec name", role = "Reversal",
			isRoot = true, connectionPointSpecification = [ConPointSpec]} = PointSpec,
...
resource_to_map(_Config) ->
	...
	ResourceRecord = #resource{id = Id,
			...
			connectivity = [#connectivity{name = "Connectivity test",
					type = "Connectivity type", minItems = 5,
					endPoints = [#point{id = "123", name = "Point name",
						href = "http://35.229.193.25:8088/eventManagement/v1/event",
						isRoot = true,
						connectionPoint = [#connection_point{id = "321",
			...
			specification = #specification_ref{id = ResourceId,
					...
					connectivitySpecification = [#connectivity_spec{
						name = "Connectivity spec test", minItems = 2,
						type = "Connectivity spec type",
						endPoint = [#point_spec{id = "258", name = "Point spec name",
							href = "http://35.229.193.25:8088/eventManagement/v1/event",
							isRoot = true, role = "Reversal",
							connectionPointSpecification = [#connection_point_spec{id = "963",
								href = "http://35.229.193.25:8088/eventManagement/v1/event",
