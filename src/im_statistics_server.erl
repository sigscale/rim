...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%
-module(im_statistics_server).
-copyright('Copyright (c) 2021 SigScale Global Inc.').

-behaviour(gen_server).

%% export the im_statistics_server API
-export([start_link/0]).
...
start_link() ->
	case gen_server:start_link({local, im_statistics},
			?MODULE, [[]], []) of
		{ok, Child} ->
			{ok, Child};
		{error, Reason} ->
...
%%----------------------------------------------------------------------
%%  The im_statistics_server gen_server call backs
%%----------------------------------------------------------------------
