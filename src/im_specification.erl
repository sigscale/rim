...
ngc_slice() ->
	...
	ServiceProfileList = #specification_char{name = "serviceProfileList",
			description = "List of ServiceProfile supported by the network slice",
	...
	Sst = #specification_char{name = "sst",
			...
			value_type = "Sst",
			value_schema = "/resourceCatalogManagement/v3/schema/sliceNrm#/definitions/Sst"},
	Chars = [DnPrefix, UserLabel, UserDefinedNetworkType, SetOfMcc, NSSIId,
			OperationalState, AdministrativeState, ServiceProfileList, Sst],
	#specification{name = "NetworkSlice",
			description = "5G Core (5GC) Network Slice",
...
ngc_amf() ->
	...
	Chars = [ID, UserLabel, VnfParametersList, PLMNIdList, AmfIdentifier,
			SBIFqdn, SBIServiceList, WeightFactor, Nssai, AmfSet],
...
ngc_upf() ->
	...
	Nssai = #specification_char{name = "nssai",
			...
			value_type = "",
			value_schema = "/resourceCatalogManagement/v3/schema/ngcNrm#/definitions/"},
	Chars = [ID, UserLabel, VnfParametersList, PLMNIdList, TacList, Nssai],
...
ngc_pcf() ->
	...
	#specification{name = "PCFFunction",
			description = "5G Policy Control Function",
...
ngc_ausf() ->
	...
	#specification{name = "AUSFFunction",
			description = "5G Authentication Server Function",
...
ngc_udm() ->
	...
	#specification{name = "UDMFunction",
			description = "5G Unified Data Management",
...
ngc_udr() ->
	...
	#specification{name = "UDRFunction",
			description = "5G Unified Data Repository",
...
ngc_udsf() ->
	...
	#specification{name = "UDSFFunction",
			description = "5G Unified Data Storage Function",
...
ngc_smsf() ->
	...
	#specification{name = "SMSFFunction",
			description = "5G Short Message Service Function",
...
ngc_lmf() ->
	...
	#specification{name = "LMFFunction",
			description = "5G Location Management Function",
...
ngc_ngeir() ->
	...
	#specification{name = "NGEIRFunction",
			description = "5G NG Equipment Identity Register",
